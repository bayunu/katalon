...
public class KinoAndroidSignIn {
	...
	def signInKinoAndroid(username, password) {
		...
		Mobile.tap(findTestObject('Object Repository/Android/Kino/SignInSignOut/android.widget.TextView - Profil'), 0)

		// Cek Kondisi Kalo Misal Udah Login atau Belum Login
		if (Mobile.verifyElementVisible(findTestObject('Object Repository/Android/Kino/SignInSignOut/android.widget.TextView - Tombol Masuk Sebelum Input Username'), 0)) {
